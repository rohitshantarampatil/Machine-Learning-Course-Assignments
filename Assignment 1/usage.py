...
for criteria in ['information_gain']:
    ...
    for cls in y.unique():
        ...
        print('Recall: for class ',cls ," : ", recall(y_hat, y, cls))
...
# reference for some functions : https://towardsdatascience.com/decision-tree-from-scratch-in-python-46e99dfea775
